...
CREATE TABLE `SavedImage` (
    ...
    UNIQUE INDEX `SavedImage_imageId_userId_key`(`imageId`, `userId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `CommentImage` ADD CONSTRAINT `CommentImage_imageId_fkey` FOREIGN KEY (`imageId`) REFERENCES `Image`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
